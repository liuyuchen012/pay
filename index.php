...
if (isset($_GET['monnny'])) {  
    ...
    header("Location: http://pay.615mc.cn/error405.html"); 
}  
...
：</dt>
                    <dd>
                        <input id="WIDsubject" name="WIDsubject" value="<?php echo $spname; ?>" readonly/>
                    </dd>
                    <hr class="one_line">
                    <dt>付款金额
：</dt>
                    <dd>
                        <input id="WIDtotal_amount" name="WIDtotal_amount" value=" <?php echo $monnny; ?>" readonly/>
                    </dd>
                    <hr class="one_line">
                    <dt>商品描述：</dt>
                    <dd>
